    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="add-car-inputs">
            <div class="add-car-inner">
                ...
                <input type="text" name="going_from" placeholder="Enter Starting Destination Details" value="<?= $posts['going_from'] ?>">
                <input type="text" name="going_to" placeholder="Enter Final Destination Details" value="<?= $posts['going_to'] ?>">

                <label for="image">Route Image</label>
                <label for="message">Addittional Message</label>
                <input type="file" name="image">
                <textarea type="text" name="message" placeholder="Enter Extra Information" value=""><?= $posts['post_message'] ?></textarea>
